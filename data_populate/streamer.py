...
# Import cache service (add parent directory to path)
...
class RealTimeStreamer:
    def __init__(self, update_interval=None):
        ...
        self.hourly_ohlc = defaultdict(lambda: {
            ...
            'volume': 0, 'oi': 0, 'first_tick_time': None, 'last_tick_time': None
        })
    ...
    def log_status_update(self):
        ...
        logging.info(
            ...
            f"{self.total_records_processed:,} saved | Failed: {self.failed_db_operations}"
        )
